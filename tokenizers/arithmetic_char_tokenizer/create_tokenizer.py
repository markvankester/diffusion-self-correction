...
def build_tokenizer():
    ...
    vocab_list = SPECIAL_TOKENS + sorted(ARITHMETIC_CHARS)
    vocab_dict = {ch: i for i, ch in enumerate(vocab_list)}

    print(f"Arithmetic characters: {sorted(ARITHMETIC_CHARS)}")
    ...
    print(f"\nSaved arithmetic character tokenizer to {out_dir}/")

    test_str = "312*310=96720"
    print("\nSanity check:")
